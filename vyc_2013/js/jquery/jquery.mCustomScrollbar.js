		...
		scrolling:function(mCustomScrollBox,mCSB_container,mCSB_draggerContainer,mCSB_dragger,mCSB_buttonUp,mCSB_buttonDown,mCSB_buttonLeft,mCSB_buttonRight){
			...
			if($this.data("mouseWheel")){
				...
				mCustomScrollBox.unbind("mousewheel").bind("mousewheel",function(event,delta){
					...
					mCSB_containerY=Math.round(mCSB_container.position().top);
					top_coord = 0;
					bottom_coord = mCustomScrollBox.height() - mCSB_container.outerHeight()+20;
					console.log(bottom_coord);
					console.log(mCSB_containerY);
					console.log(delta);
					console.log(mCSB_containerY<=bottom_coord)
					
					if ( (mCSB_containerY<0) && (mCSB_containerY>bottom_coord) || ( (mCSB_containerY>=0) && (delta<0) ) || ( (mCSB_containerY<=bottom_coord) && delta>0) )
						event.preventDefault();
					else
						return;
