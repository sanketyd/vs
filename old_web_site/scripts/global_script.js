function startSwamijiSlideshow(folder_path) {
		console.log(1234);
		$j.getJSON("subpages/list.php?path="+folder_path, function(data) {
			...
			var quotations = ["See for the highest, aim at that highest, and you shall reach the highest.", 
				...
				//Start slideshow simultaneously
...
function startSwamijiPicSlideshow(folder_path)  {
	...
	$j.getJSON("subpages/list_files.php?path="+folder_path, function(data) {
		var images=data;
		console.log(images);
