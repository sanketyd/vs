...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Vivekananda samiti: August Convention Gallery</title>
		...
		<script type='text/javascript'>
			$j(document).ready(function() {
				...
				var images = new Array('DSC03997.JPG', 'DSC04000.JPG', 'DSC04010.JPG', 'DSC04012.JPG', 'DSC04014.JPG', 'IMG_0098.JPG');
				var imagesFolderPath = "images/august_convention/";
				marqueeId = "image_scroller1";
				gridViewId = "image_grid_view1";
				var sectionHeading = "August convention pics";
