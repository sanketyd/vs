...
<body>
	<div id="container">
		...
		<div id="footer">
			...
			<a href="?page=activities/2012/list">Activities</a>
			...
			<div id="join-us">
				<a href="#">Join us:</a> 
				<a title="Subscribe to our mailing list and recieve email notifications about the samiti activities." target="_blank" href="https://docs.google.com/spreadsheet/embeddedform?formkey=dC1naFhHeFhXcjJ1ZDZEM2xaaFFLTVE6MQ"><img src="<?php load_res('styles/images/Social-Icons-Sketch-Black/Social-Icons-Black-32px/Email_32px.png'); ?>"/></a>
