...
/* Tilegroup settings */
$groupTitles = array('Notice board', 'Home','Events','Contact us'); // titles of the tileGroups
$groupSpacing = array(3,4.5,5); // width of each tileGroup (spacing between the groups in tiles)
...
/* Background */
$bgColor = "#ffd974"; // background color
