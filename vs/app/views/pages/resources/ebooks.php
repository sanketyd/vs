...
<div style="height: 50px;"><h1>E-Books</h1></div>

<div style='margin-bottom:5px; font-size:1.5em; color:brown;'>Freely downloadable ebooks</div>
...
<div style='margin-bottom:5px; font-size:1.5em; color:brown;'>Other reference websites</div>
<div name='spacing' style='padding-top: 5px;'></div>

<ul>
	<li><a href="http://ibnlive.in.com/yuva/" target="_blank">CNN-IBN Yuva</a></li>
	<li><a href="http://www.advaitaashrama.org/" target="_blank">Advaita Ashrama</a></li>
	<li><a href="http://www.ramakrishnalucknow.org/" target="_blank">Ramakrishna Mission, Lucknow</a></li>
	<li><a href="http://www.belurmath.org/" target="_blank">Belur Math and Ramakrishna Mission</a></li>
</ul>
