...
tiles = function(){ /*Insert your own tiles here*/
	...
	tileTitleText(0,0,0,2,1,'#789600','external:http://metro-webdesign.info','Welcome','This is what you get when you donate for the full version of the Metro UI template.<p> Please read the tutorial at <br> <strong>http://metro-webdesign.info</strong> when you start!',['','',''],'');
	...
	tileHoverEffectLeft(1,0,1,2,1,"#F90","Images 2","img/bg/img_300x145.jpg","Another effect",['Hover me!','#3B659C','top'],'');
	tileHoverEffectRight(1,0,2,2,1,"#3B659C","","img/bg/img_300x145.jpg","Another effect",['Hover me!','#F90','bottom'],'noClick');
	
	tileImg(1,2,0,1,1,"#F60","Images 3","img/bg/img_square.jpg",1,1,['Image, hover','#789600','bottom','Some description',true],'');
	tileImg(1,2,1,1,1,"#F90","","img/bg/img_square.jpg",1,1,['Test','#F90','top','Label at top',true],'noClick');
	tileImg(1,2,2,1,1,"#C33","","img/bg/img_square.jpg",1,1,['Another','#C33','bottom','Some description',false],'noClick');
