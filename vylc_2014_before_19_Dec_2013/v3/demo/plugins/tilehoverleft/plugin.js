...
tileHoverEffectLeft = function(group,x,y,width,height,bg,linkPage,image,content,labelSettings,optClass){ // make your own tiles
	...
	$page.content += (
	"<a "+makeLink(linkPage)+" class='tileHoverEffectLeft tile group"+group+" "+optClass+"' style=' \
